...
def train():
    ...
    config = {
        ...
        'num_blocks_2': 1,  
        'out_channels': 6,  
        'num_heads': num_classes,  # Uninportant for pretraining
        'batch_size': args.batch_size  # Retained from your example, replace args.batch_size with a specific value if needed
    }
