...
writer = SummaryWriter(log_dir='/local/scratch/jrs596/CocoaNet50_pretrained/FeatEx_logs')
    ...
    while epoch > 0 and patience_ > 0: # train_loss < loss_to_beat * 0.8:
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_loss < best_loss:
                ...
                model_path = '/local/scratch/jrs596/CocoaNet50_pretrained/models/CocoaNet50_pretrained_FeatEx_model.pkl'
                ...
                torch.save(model, '/local/scratch/jrs596/CocoaNet50_pretrained/models/CocoaNet50_pretrained_FeatEx_model.pth')
