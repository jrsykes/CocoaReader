    ...
    while patience_ > 0: # Run untill validation loss has not improved for n epochs equal to patience variable
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_recall > best_recall:
                ...
                model_path = '/local/scratch/jrs596/ResNetFung50_Torch/models/ResNet18_model.pkl'
                with open(model_path, 'wb') as f:
                    pickle.dump(final_out, f)

                # Save the whole model with pytorch save function
                torch.save(model, '/local/scratch/jrs596/ResNetFung50_Torch/models/ResNet18_model.pth')
