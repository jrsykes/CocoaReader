...
N = 48712 # image number

y_train = np.load('/local/scratch/jrs596/ResNetVAE/results/y_{}_train_epoch{}.npy'.format(exp, epoch))
z_train = np.load('/local/scratch/jrs596/ResNetVAE/results/z_{}_train_epoch{}.npy'.format(exp, epoch))
