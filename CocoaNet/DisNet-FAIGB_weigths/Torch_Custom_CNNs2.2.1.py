...
def train():
    ...
    if wandb.config.criterion == 'DFLOSS':
        criterion = {'train': toolbox.DynamicFocalLoss(delta=1, dataloader=dataloaders_dict['train']), 'val': nn.CrossEntropyLoss()}    
    elif wandb.config.criterion == 'cross_entropy':
