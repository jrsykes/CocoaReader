...
#    model = Model(inputs = base_model.input, outputs = predictions)
    ...
    model.save('/local/scratch/jrs596/ResNetFung50/models/DesUNet_model_bias_7-2-22.h5')#

    yaml_model= model.to_yaml()
    with open('/local/scratch/jrs596/ResNetFung50/models/DesUNet_model_bias_7-2-22.yaml', 'w') as yaml_file:
