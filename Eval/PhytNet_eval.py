...
# resnet18_cococa_weights = "/users/jrs596/scratch/models/ResNet18-Cocoa-FullSupervised.pth"
...
dataloaders_dict = {x: torch.utils.data.DataLoader(image_datasets[x], batch_size=batch_size, shuffle=True, num_workers=10, worker_init_fn=toolbox.worker_init_fn, drop_last=False) for x in ['train', 'val']}
