...
# save model
save_model_path = '/local/scratch/jrs596/ResNetVAE/results101'
...
writer = SummaryWriter(log_dir='/local/scratch/jrs596/ResNetVAE/results101/logs')
...
for epoch in range(epochs):
    ...
    X_reconst_test, y_test, z_test, mu_test, logvar_test, test_loss = validation(resnet_vae, device, optimizer, valid_loader)
