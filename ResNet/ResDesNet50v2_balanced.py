...
with strategy.scope():
    ...
    train_ds = train_datagen.flow_from_directory(
        '/local/scratch/jrs596/dat/ResNetFung50+_images_organised_balanced/train',
        target_size=(img_height, img_width),
        batch_size=batch_size,
        class_mode='categorical')

    data_generator_no_aug = ImageDataGenerator()
    val_ds = data_generator_no_aug.flow_from_directory('/local/scratch/jrs596/dat/ResNetFung50+_images_organised_balanced/val',
        target_size=(img_height, img_width),
        class_mode='categorical')
    ...
    model.save('/local/scratch/jrs596/ResNetFung50/models/ResDesNet50V2_model_balanced.h5')#

    yaml_model= model.to_yaml()
    with open('/local/scratch/jrs596/ResNetFung50/models/ResDesNet50V2_model_balanced.yaml', 'w') as yaml_file:
