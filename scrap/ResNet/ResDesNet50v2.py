...
with strategy.scope():
    ...
    model.save('/local/scratch/jrs596/ResNetFung50/models/ResDesNet50V2_model.h5')#

    yaml_model= model.to_yaml()
    with open('/local/scratch/jrs596/ResNetFung50/models/ResDesNet50V2_model.yaml', 'w') as yaml_file:
