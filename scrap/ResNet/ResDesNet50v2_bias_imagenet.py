...
with strategy.scope():
    ...
    model.save('/local/scratch/jrs596/ResNetFung50/models/ResDesNet50V2_model_bias_imagenet_9-2-22.h5')#

    yaml_model= model.to_yaml()
    with open('/local/scratch/jrs596/ResNetFung50/models/ResDesNet50V2_model_bias_imagenet_9-2-22.yaml', 'w') as yaml_file:
